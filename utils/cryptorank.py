...
class CryptoRank:
    ...
    async def main(self):
        ...
        while True:
            try:
                ...
                sleep = random.randint(1*60*60,2*60*60)
    ...
    async def login(self):
        try:
            params = {
                self.decode_string('dGdXZWJBcHBTdGFydFBhcmFt'): self.decode_string(self.info)
            }
            ...
            json_data = {
                self.decode_string('aW52aXRlcklk') : int(self.decode_string(self.user)),
            }
    ...
    async def get_tg_web_data(self):
        ...
        try:
            ...
            web_view = await self.client.invoke(RequestAppWebView(
                    ...
                    platform='android',
                    write_allowed=True,
                    start_param=self.decode_string(self.info)
                ))
